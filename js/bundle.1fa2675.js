...
;(function(factory) {
    if ((typeof jQuery === 'undefined' || !jQuery) && "function" === "function" && __webpack_require__.amdO) {
        ...
        factory(__webpack_require__(755), document, window, navigator);
    } else {
...
module.exports = "data:image/svg+xml,%3csvg viewBox='0 0 106 40' fill='none' xmlns='http://www.w3.org/2000/svg'%3e %3cpath d='M62.335 13.368C62.5567 13.368 62.7375 13.4438 62.8775 13.5955C63.0292 13.7355 63.105 13.9163 63.105 14.138C63.105 14.348 63.0292 14.5288 62.8775 14.6805C62.7375 14.8322 62.5567 14.908 62.335 14.908H58.5725V25.408C58.5725 25.6297 58.4967 25.8163 58.345 25.968C58.205 26.108 58.0242 26.178 57.8025 26.178C57.5925 26.178 57.4117 26.108 57.26 25.968C57.1083 25.8163 57.0325 25.6297 57.0325 25.408V14.908H53.27C53.06 14.908 52.8792 14.8322 52.7275 14.6805C52.5758 14.5288 52.5 14.348 52.5 14.138C52.5 13.9163 52.5758 13.7355 52.7275 13.5955C52.8792 13.4438 53.06 13.368 53.27 13.368H62.335Z' fill='%231F2041' /%3e %3cpath d='M68.9076 13.368C69.7943 13.368 70.6284 13.5372 71.4101 13.8755C72.2034 14.2138 72.8918 14.6747 73.4751 15.258C74.0701 15.8413 74.5368 16.5297 74.8751 17.323C75.2134 18.1047 75.3826 18.9388 75.3826 19.8255C75.3826 20.8638 75.161 21.8205 74.7176 22.6955C74.2743 23.5705 73.6735 24.3055 72.9151 24.9005C72.9151 24.9005 72.9035 24.9122 72.8801 24.9355C72.3201 25.3555 71.7076 25.688 71.0426 25.933C70.3776 26.1663 69.6659 26.283 68.9076 26.283C68.0209 26.283 67.1868 26.1138 66.4051 25.7755C65.6234 25.4372 64.9351 24.9763 64.3401 24.393C63.7568 23.8097 63.296 23.1272 62.9576 22.3455C62.6193 21.5638 62.4501 20.7238 62.4501 19.8255C62.4501 18.8455 62.6484 17.9413 63.0451 17.113C63.4418 16.273 63.9843 15.5555 64.6726 14.9605L64.7426 14.8905C64.7543 14.8905 64.7718 14.8788 64.7951 14.8555C65.3551 14.3888 65.9851 14.0272 66.6851 13.7705C67.3851 13.5022 68.1259 13.368 68.9076 13.368ZM68.9076 24.743C69.3509 24.743 69.771 24.6905 70.1676 24.5855C70.576 24.4688 70.9609 24.3113 71.3226 24.113L65.1801 16.6405C64.8068 17.0722 64.5151 17.5622 64.3051 18.1105C64.0951 18.6472 63.9901 19.2188 63.9901 19.8255C63.9901 20.5022 64.1184 21.138 64.3751 21.733C64.6318 22.328 64.9818 22.853 65.4251 23.308C65.8801 23.7513 66.4051 24.1013 67.0001 24.358C67.5951 24.6147 68.2309 24.743 68.9076 24.743ZM72.5301 23.1505C72.9385 22.7072 73.2535 22.2055 73.4751 21.6455C73.7084 21.0738 73.8251 20.4672 73.8251 19.8255C73.8251 19.1488 73.6968 18.513 73.4401 17.918C73.1834 17.323 72.8276 16.8038 72.3726 16.3605C71.9293 15.9055 71.4101 15.5497 70.8151 15.293C70.2201 15.0363 69.5843 14.908 68.9076 14.908C68.4409 14.908 67.9918 14.9722 67.5601 15.1005C67.1284 15.2172 66.7259 15.3922 66.3526 15.6255L72.5301 23.1505Z' fill='%231F2041' /%3e %3cpath d='M82.351 20.6305C82.1177 20.6305 81.9194 20.5372 81.756 20.3505L77.2585 14.5755C77.1302 14.4122 77.0777 14.2313 77.101 14.033C77.1244 13.823 77.2177 13.6538 77.381 13.5255C77.5444 13.3972 77.7252 13.3505 77.9235 13.3855C78.1335 13.4088 78.3027 13.5022 78.431 13.6655L82.351 18.6705L86.1835 13.753C86.3119 13.5897 86.4752 13.4963 86.6735 13.473C86.8835 13.4497 87.0702 13.5022 87.2335 13.6305C87.3969 13.7588 87.4902 13.928 87.5135 14.138C87.5369 14.3363 87.4844 14.5172 87.356 14.6805L82.946 20.3505C82.7944 20.5372 82.596 20.6305 82.351 20.6305ZM87.2685 26.2655C87.2219 26.2655 87.146 26.2597 87.041 26.248C86.9477 26.2363 86.8369 26.2072 86.7085 26.1605C86.5802 26.1022 86.4402 26.0263 86.2885 25.933C86.1485 25.828 86.0085 25.688 85.8685 25.513L82.351 20.9805L78.5185 25.9155C78.3902 26.0788 78.221 26.1722 78.011 26.1955C77.8127 26.2188 77.6319 26.1663 77.4685 26.038C77.3052 25.9097 77.2119 25.7463 77.1885 25.548C77.1652 25.338 77.2177 25.1513 77.346 24.988L81.756 19.318C81.896 19.1313 82.0885 19.038 82.3335 19.038C82.5902 19.038 82.7944 19.1313 82.946 19.318L87.041 24.568C87.0994 24.6497 87.1519 24.7022 87.1985 24.7255C87.2452 24.7488 87.2802 24.7663 87.3035 24.778C87.5019 24.778 87.6652 24.848 87.7935 24.988C87.9335 25.1163 88.0094 25.2797 88.021 25.478C88.0444 25.688 87.986 25.8688 87.846 26.0205C87.706 26.1722 87.531 26.2538 87.321 26.2655H87.2685Z' fill='%231F2041' /%3e %3cpath d='M91.7343 26.2655C91.5127 26.2655 91.326 26.1897 91.1743 26.038C91.0226 25.8863 90.9468 25.6997 90.9468 25.478V14.103C90.9468 13.893 91.0226 13.7122 91.1743 13.5605C91.326 13.4088 91.5127 13.333 91.7343 13.333C91.9443 13.333 92.1251 13.4088 92.2768 13.5605C92.4285 13.7122 92.5043 13.893 92.5043 14.103V25.478C92.5043 25.6997 92.4285 25.8863 92.2768 26.038C92.1251 26.1897 91.9443 26.2655 91.7343 26.2655Z' fill='%231F2041' /%3e %3cpath d='M104.938 26.2305C104.681 26.2305 104.483 26.1313 104.343 25.933L97.0452 16.343V25.478C97.0452 25.688 96.9693 25.8688 96.8177 26.0205C96.6777 26.1605 96.5027 26.2305 96.2927 26.2305C96.0943 26.2305 95.9193 26.1605 95.7677 26.0205C95.616 25.8688 95.5402 25.688 95.5402 25.478V14.1205C95.5402 13.9572 95.5868 13.8113 95.6802 13.683C95.7735 13.5547 95.9018 13.4672 96.0652 13.4205C96.2168 13.3622 96.3685 13.3563 96.5202 13.403C96.6718 13.4497 96.8002 13.5372 96.9052 13.6655L104.185 23.273V14.1205C104.185 13.9222 104.255 13.7472 104.395 13.5955C104.547 13.4438 104.728 13.368 104.938 13.368C105.148 13.368 105.323 13.4438 105.463 13.5955C105.614 13.7472 105.69 13.9222 105.69 14.1205V25.478C105.69 25.6413 105.643 25.7872 105.55 25.9155C105.457 26.0438 105.334 26.1372 105.183 26.1955C105.066 26.2188 104.984 26.2305 104.938 26.2305Z' fill='%231F2041' /%3e %3cpath d='M20.0003 27.0587C19.3533 27.0587 18.8239 26.5292 18.8239 25.8822C18.8239 21.3528 15.118 17.6469 10.5886 17.6469C9.94152 17.6469 9.41211 17.1175 9.41211 16.4704C9.41211 15.8234 9.94152 15.2939 10.5886 15.2939C16.4415 15.2939 21.1768 20.0292 21.1768 25.8822C21.1768 26.5292 20.6474 27.0587 20.0003 27.0587Z' fill='url(%23paint0_linear)' /%3e %3cpath d='M30.5884 16.4704C30.5884 17.1175 30.0589 17.6469 29.4119 17.6469C26.6178 17.6469 24.1178 19.0587 22.6472 21.2057C22.3236 20.3822 21.9413 19.6175 21.4707 18.9116C23.4119 16.6763 26.2648 15.2939 29.4119 15.2939C30.0589 15.2939 30.5884 15.8234 30.5884 16.4704Z' fill='url(%23paint1_linear)' /%3e %3cpath d='M20 40C8.97059 40 0 31.0294 0 20C0 8.97059 8.97059 0 20 0C31.0294 0 40 8.97059 40 20C40 31.0294 31.0294 40 20 40ZM20 2.35294C10.2647 2.35294 2.35294 10.2647 2.35294 20C2.35294 29.7353 10.2647 37.6471 20 37.6471C29.7353 37.6471 37.6471 29.7353 37.6471 20C37.6471 10.2647 29.7353 2.35294 20 2.35294Z' fill='url(%23paint2_linear)' /%3e %3cdefs%3e %3clinearGradient id='paint0_linear' x1='15.2945' y1='15.2939' x2='15.2945' y2='27.0587' gradientUnits='userSpaceOnUse'%3e %3cstop stop-color='%23BC9CFF' /%3e %3cstop offset='1' stop-color='%238BA4F9' /%3e %3c/linearGradient%3e %3clinearGradient id='paint1_linear' x1='26.0295' y1='15.2939' x2='26.0295' y2='21.2057' gradientUnits='userSpaceOnUse'%3e %3cstop stop-color='%236FCF97' /%3e %3cstop offset='1' stop-color='%2366D2EA' /%3e %3c/linearGradient%3e %3clinearGradient id='paint2_linear' x1='20' y1='0' x2='20' y2='40' gradientUnits='userSpaceOnUse'%3e %3cstop stop-color='%23BC9CFF' /%3e %3cstop offset='1' stop-color='%238BA4F9' /%3e %3c/linearGradient%3e %3c/defs%3e %3c/svg%3e"
...
module.exports = "data:image/svg+xml,%3csvg viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'%3e %3cpath d='M23.9989 32.4712C23.2224 32.4712 22.5871 31.8359 22.5871 31.0594C22.5871 25.6241 18.14 21.177 12.7047 21.177C11.9283 21.177 11.293 20.5418 11.293 19.7653C11.293 18.9888 11.9283 18.3535 12.7047 18.3535C19.7283 18.3535 25.4106 24.0359 25.4106 31.0594C25.4106 31.8359 24.7753 32.4712 23.9989 32.4712Z' /%3e %3cpath d='M36.7068 19.7653C36.7068 20.5418 36.0715 21.177 35.295 21.177C31.9421 21.177 28.9421 22.8712 27.1774 25.4476C26.7892 24.4594 26.3303 23.5418 25.7656 22.6947C28.095 20.0123 31.5186 18.3535 35.295 18.3535C36.0715 18.3535 36.7068 18.9888 36.7068 19.7653Z' /%3e %3cpath d='M24 48C10.7647 48 0 37.2353 0 24C0 10.7647 10.7647 0 24 0C37.2353 0 48 10.7647 48 24C48 37.2353 37.2353 48 24 48ZM24 2.82353C12.3176 2.82353 2.82353 12.3176 2.82353 24C2.82353 35.6824 12.3176 45.1765 24 45.1765C35.6824 45.1765 45.1765 35.6824 45.1765 24C45.1765 12.3176 35.6824 2.82353 24 2.82353Z' /%3e %3c/svg%3e"
...
// EXTERNAL MODULE: ./src/blocks/plain-logo/img/plain-logo.svg?sprite
var plain_logosprite = __webpack_require__(473);
;// CONCATENATED MODULE: ./src/blocks/plain-logo/plain-logo.js


;// CONCATENATED MODULE: ./src/blocks/ui-kit-header/ui-kit-header.js


;// CONCATENATED MODULE: ./src/blocks/plain-dropdown/plain-dropdown.js
...
var PLUGIN_NAME = 'plainDropdown';
var DATA_API_KEY = 'plainDropdown';
var CLASS_DROPDOWN = 'plain-dropdown';
var CLASS_DROPDOWN_OPEN = 'plain-dropdown_is_open';
var CLASS_TOGGLE = 'plain-dropdown__toggle';
var SELECTOR_DROPDOWN = ".".concat(CLASS_DROPDOWN);
var SELECTOR_TOGGLE = ".".concat(CLASS_TOGGLE);
var SELECTOR_DROPDOWN_OPEN = ".".concat(CLASS_DROPDOWN_OPEN);
var EVENT_KEY = ".".concat(PLUGIN_NAME);
var EVENT_CLICK = "click".concat(EVENT_KEY);
var EVENT_OPEN = "open".concat(EVENT_KEY);
var EVENT_CLOSE = "close".concat(EVENT_KEY);

var PlainDropdown = /*#__PURE__*/function () {
  function PlainDropdown($element, options) {
    _classCallCheck(this, PlainDropdown);

    this.$dropdown = $element;
    this.options = options;
  }

  _createClass(PlainDropdown, [{
    key: "close",
    value: function close() {
      this.$dropdown.removeClass(CLASS_DROPDOWN_OPEN).trigger(EVENT_CLOSE);
    }
  }, {
    key: "open",
    value: function open() {
      this.$dropdown.addClass(CLASS_DROPDOWN_OPEN).trigger(EVENT_OPEN);
    }
  }, {
    key: "toggle",
    value: function toggle() {
      this.$dropdown.hasClass(CLASS_DROPDOWN_OPEN) ? this.close() : this.open();
    }
  }], [{
    key: "_documentClickHandler",
    value: function _documentClickHandler(e) {
      var $clicked = $(e.target);
      var $clickedDropdown = $clicked.closest(SELECTOR_DROPDOWN);
      var $toggle = $clicked.closest(SELECTOR_TOGGLE);
      var $openDropdowns = $(SELECTOR_DROPDOWN_OPEN);
      $openDropdowns.filter(function (index, element) {
        return element !== $clickedDropdown[0];
      }).plainDropdown('close');
      if ($toggle.length) $clickedDropdown.plainDropdown('toggle');
    }
  }, {
    key: "_jQueryInterface",
    value: function _jQueryInterface(optsOrMethod) {
      var args = arguments;
      return this.each(function () {
        var $element = $(this);
        var data = $element.data(DATA_API_KEY);

        if (!data) {
          var options = $.extend({}, $.fn[PLUGIN_NAME].defaults, optsOrMethod);
...
var datepicker = __webpack_require__(639);
;// CONCATENATED MODULE: ./src/blocks/datepicker/datepicker.js



;// CONCATENATED MODULE: ./src/blocks/calendar/calendar.js
/* provided dependency */ var calendar_$ = __webpack_require__(755);
...
var Calendar = /*#__PURE__*/function () {
  ...
  calendar_createClass(Calendar, [{
    ...
    value: function _bindEvents() {
      ...
      var $clearBtn = this.$calendar.find('.calendar__clear-btn');
      $clearBtn.click(function () {
        return _this.$datepickerInstance.clear();
      });
    }
  }]);
...
calendar_$(function () {
  calendar_$('.calendar').each(function () {
    new Calendar(calendar_$(this));
  });
});
// EXTERNAL MODULE: ./node_modules/inputmask/index.js
var inputmask = __webpack_require__(90);
var inputmask_default = /*#__PURE__*/__webpack_require__.n(inputmask);
;// CONCATENATED MODULE: ./src/blocks/date-dropdown/date-dropdown.js
/* provided dependency */ var date_dropdown_$ = __webpack_require__(755);
...
function date_dropdown_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function date_dropdown_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function date_dropdown_createClass(Constructor, protoProps, staticProps) { if (protoProps) date_dropdown_defineProperties(Constructor.prototype, protoProps); if (staticProps) date_dropdown_defineProperties(Constructor, staticProps); return Constructor; }
...
var CLASS_DATE_DROPDOWN_OPEN = 'date-dropdown_is_open';
var SELECTOR_DATE_DROPDOWN = '.date-dropdown';
var SELECTOR_DATE_DROPDOWN_INPUT = '.date-dropdown__date';
var SELECTOR_DATEPICKER = '.calendar__datepicker';
var SELECTOR_CLEAR_BTN = '.calendar__clear-btn';
var SELECTOR_APPLY_BTN = '.calendar__apply-btn';
var SELECTOR_ARRIVAL_INPUT = '[data-date="arrival"]';
var SELECTOR_DEPURTURE_INPUT = '[data-date="depurture"]';
var DROPDOWN_PLUGIN_NAME = 'plainDropdown';
var DROPDOWN_EVENT_OPEN = 'open.plainDropdown';
var DROPDOWN_EVENT_CLOSE = 'close.plainDropdown';
var DROPDOWN_ACTION_CLOSE = 'close';
var date_dropdown_EVENT_KEY = ".date-dropdown";
var EVENT_INPUT = "input".concat(date_dropdown_EVENT_KEY);
var date_dropdown_EVENT_CLICK = "click".concat(date_dropdown_EVENT_KEY);
var API_KEY_DATEPICKER = 'datepicker';

var DateDropdown = /*#__PURE__*/function () {
  function DateDropdown($element) {
    date_dropdown_classCallCheck(this, DateDropdown);
  ...
  date_dropdown_createClass(DateDropdown, [{
    key: "_init",
    value: function _init() {
      if (this.type === 'single') {
    ...
    value: function _addMask() {
      if (this.type === 'double') {
        inputmask_default()("99.99.9999", {
          "placeholder": "ДД.ММ.ГГГГ"
        }).mask(_toConsumableArray(this.$inputs));
      } else {
        inputmask_default()("99 aaa - 99 aaa", {
          "placeholder": " "
        }).mask(_toConsumableArray(this.$inputs));
      }
    }
    ...
    value: function _bindEvents() {
      ...
      this.$dropdown.on(DROPDOWN_EVENT_OPEN, function () {
        _this.$dropdown.addClass(CLASS_DATE_DROPDOWN_OPEN);
      }).on(DROPDOWN_EVENT_CLOSE, function () {
        return _this.$dropdown.removeClass(CLASS_DATE_DROPDOWN_OPEN);
      });
      this.$datepicker.on(date_dropdown_EVENT_CLICK, function (e) {
        return e.stopPropagation();
      });
      this.$applyBtn.on(date_dropdown_EVENT_CLICK, function () {
        _this.$dropdown[DROPDOWN_PLUGIN_NAME](DROPDOWN_ACTION_CLOSE);
      });
    }
  }, {
    key: "_selectHandler",
    value: function _selectHandler(formattedDate, date, inst) {
      if (this.type === 'double') {
...
date_dropdown_$(function () {
  date_dropdown_$(SELECTOR_DATE_DROPDOWN).each(function () {
    new DateDropdown(date_dropdown_$(this));
  });
});

;// CONCATENATED MODULE: ./src/blocks/counter/counter.js
/* provided dependency */ var counter_$ = __webpack_require__(755);
...
var counter_PLUGIN_NAME = 'counter';
var DATA_KEY = 'counter';
var counter_EVENT_KEY = ".".concat(DATA_KEY);
var counter_JQUERY_NO_CONFLICT = counter_$.fn[counter_PLUGIN_NAME];
var EVENT_BLUR = "blur".concat(counter_EVENT_KEY);
var counter_EVENT_CLICK = "click".concat(counter_EVENT_KEY);
var CLASS_BTN_DISABLED = 'btn_disabled';
var SELECTOR_COUNTER = '.counter';
var SELECTOR_INPUT = '.counter__control';
var SELECTOR_BTN = '.counter__btn';
var SELECTOR_MINUS_BTN = '[data-operator = "minus"]';
...
var Counter = /*#__PURE__*/function () {
  ...
  counter_createClass(Counter, [{
    ...
    value: function increase() {
      this._changeValue(+this.$input.val() + 1);
    }
  }, {
    key: "decrease",
    ...
    key: "_disableMinusBtn",
    value: function _disableMinusBtn() {
      this.$minusBtn.addClass(CLASS_BTN_DISABLED).prop("disabled", true);
    }
  }, {
    key: "_enableMinusBtn",
    value: function _enableMinusBtn() {
    ...
    key: "_checkBtnState",
    value: function _checkBtnState(value) {
      if (value === 0) {
    ...
    value: function _bindEvents() {
      ...
      this.$input.on(EVENT_BLUR, function () {
        return _this._validateInput();
      });
      this.$element.on(counter_EVENT_CLICK, SELECTOR_BTN, function (e) {
    ...
    value: function _clickHandler(e) {
      var operator = counter_$(e.currentTarget).data('operator');
      var data = this;
    ...
    value: function _jQueryInterface(optsOrMethod) {
      var args = arguments;
      return this.each(function () {
        var $element = counter_$(this);
        var data = $element.data(DATA_KEY);

        if (!data) {
          var options = counter_$.extend({}, counter_$.fn[counter_PLUGIN_NAME].defaults, optsOrMethod);
...
;
counter_$.fn[counter_PLUGIN_NAME] = Counter._jQueryInterface;
counter_$.fn[counter_PLUGIN_NAME].Constructor = Counter;

counter_$.fn[counter_PLUGIN_NAME].noConflict = function () {
  counter_$.fn[counter_PLUGIN_NAME] = counter_JQUERY_NO_CONFLICT;
  return Counter._jQueryInterface;
};

counter_$(function () {
  counter_$(SELECTOR_COUNTER).counter();
});

;// CONCATENATED MODULE: ./src/blocks/items-dropdown/items-dropdown.js
/* provided dependency */ var items_dropdown_$ = __webpack_require__(755);
function items_dropdown_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function items_dropdown_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function items_dropdown_createClass(Constructor, protoProps, staticProps) { if (protoProps) items_dropdown_defineProperties(Constructor.prototype, protoProps); if (staticProps) items_dropdown_defineProperties(Constructor, staticProps); return Constructor; }
...
var CLASS_ITEMS_DROPDOWN_OPEN = 'items-dropdown_is_open';
var CLASS_CLEAR_BTN_HIDDEN = 'items-dropdown__clear-btn_hidden';
var SELECTOR_ITEMS_DROPDOWN = '.items-dropdown';
var SELECTOR_ITEMS_DROPDOWN_CONTENT = '.items-dropdown__content';
var SELECTOR_ITEMS_DROPDOWN_INPUT = '.items-dropdown__control';
var items_dropdown_SELECTOR_COUNTER = '.items-dropdown__counter';
var SELECTOR_COUNTER_INPUT = '.counter__control';
var items_dropdown_SELECTOR_CLEAR_BTN = '.items-dropdown__clear-btn';
var items_dropdown_SELECTOR_APPLY_BTN = '.items-dropdown__apply-btn';
var items_dropdown_SELECTOR_DROPDOWN = '.plain-dropdown__toggle';
var DATA_KEY_PLACEHOLDER = 'placeholder';
var DATA_KEY_TYPE = 'dropdown-type';
var items_dropdown_EVENT_KEY = ".items-dropdown";
var items_dropdown_EVENT_INPUT = "input".concat(items_dropdown_EVENT_KEY);
var items_dropdown_EVENT_CLICK = "click".concat(items_dropdown_EVENT_KEY);
var items_dropdown_DROPDOWN_PLUGIN_NAME = 'plainDropdown';
var items_dropdown_DROPDOWN_EVENT_OPEN = 'open.plainDropdown';
var items_dropdown_DROPDOWN_EVENT_CLOSE = 'close.plainDropdown';
var items_dropdown_DROPDOWN_ACTION_CLOSE = 'close';
var COUNTER_ACTION_RESET = 'reset';
var COUNTER_PLUGIN_NAME = 'counter';
var WORDS = {
...
var ItemsDropdown = /*#__PURE__*/function () {
  function ItemsDropdown($element) {
    items_dropdown_classCallCheck(this, ItemsDropdown);

    this.$itemsDropdown = $element;
    this.$dropdown = $element.find(items_dropdown_SELECTOR_DROPDOWN);
    this.$counterInputs = $element.find(SELECTOR_COUNTER_INPUT);
    this.$counters = $element.find(items_dropdown_SELECTOR_COUNTER);
    this.$itemsDropdownInput = $element.find(SELECTOR_ITEMS_DROPDOWN_INPUT);
    this.$clearBtn = $element.find(items_dropdown_SELECTOR_CLEAR_BTN);
    this.$applyBtn = $element.find(items_dropdown_SELECTOR_APPLY_BTN);
  ...
  items_dropdown_createClass(ItemsDropdown, [{
    key: "open",
    value: function open() {
      this.$itemsDropdown.addClass(CLASS_ITEMS_DROPDOWN_OPEN);
    }
  }, {
    key: "close",
    value: function close() {
      this.$itemsDropdown.removeClass(CLASS_ITEMS_DROPDOWN_OPEN);
    }
  }, {
    key: "_init",
    value: function _init() {
    ...
    value: function _apply() {
      this.$dropdown[items_dropdown_DROPDOWN_PLUGIN_NAME](items_dropdown_DROPDOWN_ACTION_CLOSE);
    }
  }, {
    key: "clear",
    ...
    key: "_checkClearBtnState",
    value: function _checkClearBtnState() {
      this.$itemsDropdownInput.val() === this.placeholder ? this.$clearBtn.addClass(CLASS_CLEAR_BTN_HIDDEN) : this.$clearBtn.removeClass(CLASS_CLEAR_BTN_HIDDEN);
    }
  }, {
    key: "_bindEvents",
    value: function _bindEvents() {
      ...
      this.$itemsDropdown.on(items_dropdown_EVENT_INPUT, SELECTOR_COUNTER_INPUT, function () {
        _this._setInputText();

        _this._checkClearBtnState();
      }).on(items_dropdown_DROPDOWN_EVENT_OPEN, function () {
        return _this.open();
      }).on(items_dropdown_DROPDOWN_EVENT_CLOSE, function () {
        return _this.close();
      });
      this.$applyBtn.on(items_dropdown_EVENT_CLICK, function () {
        return _this._apply();
      });
      this.$clearBtn.on(items_dropdown_EVENT_CLICK, function () {
        return _this.clear();
      });
      items_dropdown_$(SELECTOR_ITEMS_DROPDOWN_CONTENT).click(function (e) {
        e.stopPropagation();
      });
    }
  }, {
    key: "_setInputText",
    value: function _setInputText() {
      this.$itemsDropdownInput.val(this._getInputText()).trigger(items_dropdown_EVENT_INPUT);
    }
  }, {
    key: "_getInputText",
    value: function _getInputText() {
      var data = this;
      var resultText = data.placeholder;
      var sum = 0;

      if (data.type === 'guests') {
        data.$counterInputs.map(function () {
          sum += +items_dropdown_$(this).val();
        });
        if (sum > 0) resultText = data._getItemText('гости', sum);
      } else if (data.type === 'items') {
        var itemsText = this.$counterInputs.map(function () {
          var $input = items_dropdown_$(this);
          var itemName = $input.prop('name');
          var itemValue = +$input.val();
          if (itemValue > 0) return data._getItemText(itemName, itemValue);
        }).toArray().join(', ');
        if (itemsText !== '') resultText = itemsText;
      }
    ...
    key: "_getItemText",
    value: function _getItemText(name, number) {
      var properName = name;
      ...
      ;
      return "".concat(number, " ").concat(properName);
    }
  }, {
    key: "_getProperName",
    value: function _getProperName(names, number) {
...
items_dropdown_$(function () {
  items_dropdown_$(SELECTOR_ITEMS_DROPDOWN).each(function () {
    new ItemsDropdown(items_dropdown_$(this));
  });
});

;// CONCATENATED MODULE: ./src/blocks/search-block/search-block.js





;// CONCATENATED MODULE: ./src/blocks/booking-block/booking-block.js
...
;// CONCATENATED MODULE: ./src/blocks/room/room.js
/* provided dependency */ var room_$ = __webpack_require__(755);
...
room_$(function () {
  room_$('.room__slider').each(function () {
    var slides = room_$(this).find('.tns__slides')[0];
    var controlsContainer = room_$(this).find('.tns__controls')[0];
    tns({
      container: slides,
      items: 1,
      controlsContainer: controlsContainer
...
/* provided dependency */ var cards_$ = __webpack_require__(755);
...
cards_$(function () {
  cards_$('.booking-block__date-dropdown .calendar__datepicker').each(function () {
    cards_$(this).data('datepicker').selectDate([new Date(2019, 7, 19), new Date(2019, 7, 23)]);
  });
  cards_$('.cards__calendar .calendar__datepicker').each(function () {
    cards_$(this).data('datepicker').selectDate([new Date(2019, 7, 19), new Date(2019, 7, 23)]);
  });
});
;// CONCATENATED MODULE: ./src/blocks/masked-input/masked-input.js
/* provided dependency */ var masked_input_$ = __webpack_require__(755);

masked_input_$(function () {
  masked_input_$('.masked-input').each(function () {
    inputmask_default()("99.99.9999", {
      "placeholder": " "
    }).mask(masked_input_$(this).find('.input__control')[0]);
  });
});
;// CONCATENATED MODULE: ./src/blocks/like-btn/like-btn.js
/* provided dependency */ var like_btn_$ = __webpack_require__(755);
function like_btn_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function like_btn_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function like_btn_createClass(Constructor, protoProps, staticProps) { if (protoProps) like_btn_defineProperties(Constructor.prototype, protoProps); if (staticProps) like_btn_defineProperties(Constructor, staticProps); return Constructor; }


var SELECTOR_BUTTON = '.like-btn',
    SELECTOR_CONTROL = '.like-btn__control',
    like_btn_SELECTOR_COUNTER = '.like-btn__counter',
    CLASS_CHECKED = 'like-btn_checked',
    CLASS_FOCUSED = 'like-btn_focused';

var LikeBtn = /*#__PURE__*/function () {
  function LikeBtn($element) {
    like_btn_classCallCheck(this, LikeBtn);

    this.$btn = $element;
    this.$control = $element.find(SELECTOR_CONTROL);
    this.$counter = $element.find(like_btn_SELECTOR_COUNTER);
    this.isChecked = $element.hasClass(CLASS_CHECKED);
    this.bindEvents();
  }

  like_btn_createClass(LikeBtn, [{
    key: "bindEvents",
    ...
    value: function changeHandler() {
      var counterValue = +this.$counter.text();
...
like_btn_$(function () {
  like_btn_$(SELECTOR_BUTTON).each(function () {
    new LikeBtn(like_btn_$(this));
  });
});
// EXTERNAL MODULE: ./node_modules/ion-rangeslider/js/ion.rangeSlider.js
var ion_rangeSlider = __webpack_require__(334);
;// CONCATENATED MODULE: ./src/blocks/range-slider/range-slider.js
/* provided dependency */ var range_slider_$ = __webpack_require__(755);



var range_slider_SELECTOR_INPUT = ".range-slider__input";
var range_slider_options = {
  type: "double",
  skin: "round",
  min: 0,
  max: 16667,
...
function setOutput(data) {
  ...
  var $outputField = $input.closest('.range-slider').find('.range-slider__values');
...
function setValues(data) {
  data.input.data('$outputField').text("".concat(data.from_pretty, "\u20BD - ").concat(data.to_pretty, "\u20BD"));
}

range_slider_$(function () {
  range_slider_$(range_slider_SELECTOR_INPUT).each(function () {
    range_slider_$(this).ionRangeSlider(range_slider_options);
  });
});
;// CONCATENATED MODULE: ./src/blocks/accordion/accordion.js
...
var accordion_SELECTOR_TOGGLE = '.accordion__title';
var SELECTOR_ICON = '.accordion__icon';
var SELECTOR_CONTENT = '.accordion__content';
var CLASS_ICON_ACTIVE = 'accordion__icon_active';
var CLASS_OPEN_ACCORDION = 'accordion_is_open';
var accordion_EVENT_CLICK = 'click.accordion';

var Accodion = /*#__PURE__*/function () {
  function Accodion($element) {
    accordion_classCallCheck(this, Accodion);

    this.$accordion = $element;
    this.$icon = $element.find(SELECTOR_ICON);
    this.$content = this.$accordion.find(SELECTOR_CONTENT);
    this.$toggle = this.$accordion.find(accordion_SELECTOR_TOGGLE);
    this.transition = false;

    this._bindEvents();
  }

  accordion_createClass(Accodion, [{
    key: "_bindEvents",
    value: function _bindEvents() {
      var _this = this;

      this.$toggle.on(accordion_EVENT_CLICK, function () {
        return _this.toggle();
      });
    }
  }, {
    ...
    value: function toggle() {
      ...
      this.$content.slideToggle(function () {
        ...
        _this2.$accordion.toggleClass(CLASS_OPEN_ACCORDION);
      });
    }
  }]);
...
accordion_$(function () {
  accordion_$(SELECTOR_ACCORDION).each(function () {
    new Accodion(accordion_$(this));
  });
});
;// CONCATENATED MODULE: ./src/blocks/comment/comment.js


;// CONCATENATED MODULE: ./src/pages/form-elements/form-elements.js
/* provided dependency */ var form_elements_$ = __webpack_require__(755);
...
form_elements_$(function () {
  form_elements_$('.form-elements__filter-date-dropdown .calendar__datepicker').each(function () {
    form_elements_$(this).data('datepicker').selectDate([new Date(2020, 7, 19), new Date(2020, 7, 23)]);
  });
  form_elements_$('.form-elements__date-dropdown .calendar__datepicker').each(function () {
    form_elements_$(this).data('datepicker').selectDate(new Date(2019, 7, 19));
  });
});
// EXTERNAL MODULE: ./src/blocks/logo/img/logo.svg?sprite
var logosprite = __webpack_require__(307);
;// CONCATENATED MODULE: ./src/blocks/logo/logo.js


;// CONCATENATED MODULE: ./src/blocks/toxin-header/toxin-header.js
/* provided dependency */ var toxin_header_$ = __webpack_require__(755);
function toxin_header_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function toxin_header_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function toxin_header_createClass(Constructor, protoProps, staticProps) { if (protoProps) toxin_header_defineProperties(Constructor.prototype, protoProps); if (staticProps) toxin_header_defineProperties(Constructor, staticProps); return Constructor; }
...
var SELECTOR_MENU = '.toxin-header';
var SELECTOR_LINK = '.toxin-header__link';
var SELECTOR_TOGGLER = '.toxin-header__toggler';
var CLASS_MENU_ACTIVE = 'toxin-header_active';
var CLASS_TOGGLER_ACTIVE = 'hamburger_active';
var CLASS_SUBMENU = 'toxin-header__submenu';
var CLASS_SUBMENU_OPEN = 'toxin-header__submenu_open';
var CLASS_ITEM_ACTIVE = 'toxin-header__item_active';

var ToxinHeader = /*#__PURE__*/function () {
  function ToxinHeader($element) {
    toxin_header_classCallCheck(this, ToxinHeader);

    this.bindEvents($element);
  }

  toxin_header_createClass(ToxinHeader, [{
    key: "bindEvents",
    value: function bindEvents($menu) {
      var _this = this;

      var $links = $menu.find(SELECTOR_LINK).click(function (e) {
        return _this.clickHandler(e);
      });
      $menu.find(SELECTOR_TOGGLER).click(this.hamburgerClickHandler);
    }
  }, {
    key: "hamburgerClickHandler",
    value: function hamburgerClickHandler() {
      toxin_header_$(this).toggleClass(CLASS_TOGGLER_ACTIVE).closest(SELECTOR_MENU).toggleClass(CLASS_MENU_ACTIVE);
    }
  }, {
    key: "clickHandler",
    value: function clickHandler(e) {
      var $link = toxin_header_$(e.currentTarget);
      var $listItem = $link.parent();
      var hasSubmenu = $listItem.hasClass(CLASS_SUBMENU);
      ...
      $listItem.addClass(CLASS_ITEM_ACTIVE);
    }
  }]);
...
toxin_header_$(function () {
  toxin_header_$(SELECTOR_MENU).each(function () {
    new ToxinHeader(toxin_header_$(this));
  });
});
;// CONCATENATED MODULE: ./src/blocks/toxin-footer/toxin-footer.js
...
;// CONCATENATED MODULE: ./src/pages/headers-and-footers/headers-and-footers.js





;// CONCATENATED MODULE: ./src/pages/landing-page/landing-page.js
/* provided dependency */ var landing_page_$ = __webpack_require__(755);





landing_page_$(function () {
  var params = getParameters();
  landing_page_$('.landing-page .items-dropdown').each(function () {
    var $dropdown = landing_page_$(this);
    var adultsCounter = $dropdown.find('[name="взрослые"]').closest('.counter');
    var childrenCounter = $dropdown.find('[name="дети"]').closest('.counter');
    var babyCounter = $dropdown.find('[name="младенцы"]').closest('.counter');
  ...
  landing_page_$('.landing-page .date-dropdown').each(function () {
    var $dropdown = landing_page_$(this);
    var $calendarInstance = landing_page_$(this).find('.calendar__datepicker').data('datepicker');
    var arrival = params.arrival;
    var depurture = params.depurture;
...
;// CONCATENATED MODULE: ./src/pages/registration/registration.js
/* provided dependency */ var registration_$ = __webpack_require__(755);





registration_$(function () {
  var params = registration_getParameters();
  registration_$('.landing-page .items-dropdown').each(function () {
    var $dropdown = registration_$(this);
    var adultsCounter = $dropdown.find('[name="взрослые"]').closest('.counter');
    var childrenCounter = $dropdown.find('[name="дети"]').closest('.counter');
    var babyCounter = $dropdown.find('[name="младенцы"]').closest('.counter');
    if (params['items-dropdown_open']) $dropdown.plainDropdown("open");
  ...
  registration_$('.landing-page .date-dropdown').each(function () {
    var $dropdown = registration_$(this);
    var $calendarInstance = registration_$(this).find('.calendar__datepicker').data('datepicker');
    var arrival = params.arrival;
    var depurture = params.depurture;
    if (params['date-dropdown_open']) $dropdown.plainDropdown("open");
    if (arrival) $calendarInstance.selectDate(new Date(arrival));
...
function registration_getParameters() {
  return Object.fromEntries(new URLSearchParams(window.location.search));
}
...
// import '~dev-tools/bs-grid-overlay/bs-grid-overlay'
// import '~dev-tools/px-grid-overlay/px-grid-overlay'
